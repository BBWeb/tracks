...
function renderOptions(e, path) {
  ...
  if (e && e.type === 'submit') {
    ...
    for (var i = 0, len = elements.length, el; i < len; i++) {
      ...
      // Skip elements that shouldn't be posted.
      // Taken from $.fieldValue() in https://github.com/malsup/form/blob/4bbb64/jquery.form.js#L1043-L1048
      // See http://www.w3.org/TR/html401/interact/forms.html#h-17.13.2
      var n = el.name, t = el.type, tag = el.tagName.toLowerCase();
      if (!n || el.disabled || t == 'reset' || t == 'button' ||
        (t == 'checkbox' || t == 'radio') && !el.checked ||
        (t == 'submit' || t == 'image') || // && el.form && el.form.clk != el ||  // We don't know what element triggered the submission
